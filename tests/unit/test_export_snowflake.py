...
def _resource_path(filename):
    ...
    Only the basename of filename is honoured, and the result is verified to
    stay inside _RESOURCES_DIR so a caller can never traverse outside the
    intended fixture directory (CWE-73 remediation)."""
